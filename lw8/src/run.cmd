...
start dotnet TextSuccessMarker.dll --configuration Release --launch-profile Production

cd ../TextProcessingLimiter
start dotnet TextProcessingLimiter.dll --configuration Release --launch-profile Production