...
cd ../VowelConsCounter
dotnet publish --configuration Release -f netcoreapp2.0 -o "../../%_toBuildPathName%/VowelConsCounter" /property:PublishWithAspNetCoreTargetManifest=false

cd ../VowelConsRater
dotnet publish --configuration Release -f netcoreapp2.0 -o "../../%_toBuildPathName%/VowelConsRater" /property:PublishWithAspNetCoreTargetManifest=false

cd ../TextStatistics
dotnet publish --configuration Release -f netcoreapp2.0 -o "../../%_toBuildPathName%/TextStatistics" /property:PublishWithAspNetCoreTargetManifest=false

cd ../TextSuccessMarker
dotnet publish --configuration Release -f netcoreapp2.0 -o "../../%_toBuildPathName%/TextSuccessMarker" /property:PublishWithAspNetCoreTargetManifest=false

cd ../TextProcessingLimiter
dotnet publish --configuration Release -f netcoreapp2.0 -o "../../%_toBuildPathName%/TextProcessingLimiter" /property:PublishWithAspNetCoreTargetManifest=false
